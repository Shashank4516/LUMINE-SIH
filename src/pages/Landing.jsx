...
const Landing = () => {
  ...
  // Only redirect if they have valid auth data
  useEffect(() => {
    const checkAuth = async () => {
      try {
        ...
        if (user && user.id) {
          // User is logged in with valid data, redirect based on role
          console.log("User is logged in:", user);
          if (user.role === "mandir_admin") {
            navigate("/admin/dashboard", { replace: true });
          } else if (user.role === "security_guard") {
            navigate("/guard/dashboard", { replace: true });
          } else {
            navigate("/dashboard/slot-booking", { replace: true });
          }
        } else {
          // Invalid user data, clear and stay on landing
          ...
          console.log("Invalid user data, cleared auth and showing landing page");
        }
      } catch (error) {
        // Error getting user, clear auth and stay on landing page
        console.log("Error checking auth, showing landing page:", error);
        localStorage.removeItem("lumine_token");
        localStorage.removeItem("lumine_user");
        sessionStorage.removeItem("lumine_token");
        sessionStorage.removeItem("lumine_user");
  ...
  const handleLogin = async ({ userId, password, rememberMe, role }) => {
    ...
    try {
      ...
      if (
        ...
        handleSuccess(
          ...
          { 
            ...
            redirectUrl: "/dashboard/slot-booking",
            user: {
              id: "shiva900",
              email: userId,
              displayName: "Shiva",
      ...
      if (
        ...
        userId.trim().toLowerCase() === "guard" &&

        (password === "shivansh" || password === "SHIVASH")
        ...
        handleSuccess(
          ...
          { 
            ...
            redirectUrl: "/guard/dashboard",
            user: {
              id: "guard",
              email: "guard@lumine.com",
  ...
  const handleSuccess = (data, rememberMe) => {
    ...
    if (rememberMe) {
      ...
      if (data.user) {
        sessionStorage.setItem("lumine_user", JSON.stringify(data.user));
      }
    ...
    setTimeout(() => {
      ...
      navigate(data.redirectUrl || "/dashboard/slot-booking");
  ...
  return (
    ...
    <div className="bg-sand font-sans text-gray-800 min-h-screen flex flex-col" style={{ minHeight: '100vh' }}>
          ...
          <div className="hidden lg:block space-y-8 animate-fade-in-up">
            ...
            <div className="space-y-4">
              ...
              <h1 className="font-serif text-5xl xl:text-6xl font-bold text-gray-900 leading-tight">
                ...
                <span className="text-saffron-600" data-key="welcomeSub">
            ...
            <div className="grid grid-cols-2 gap-6">
              ...
              <div className="flex items-start gap-3 p-4 bg-white rounded-xl border border-saffron-50 shadow-sm">
                ...
                <div className="p-2 bg-saffron-100 rounded-lg text-saffron-600 flex items-center justify-center">

                  <HandsPraying weight="duotone" size={24} />
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500" data-key="card1Desc">
              ...
              <div className="flex items-start gap-3 p-4 bg-white rounded-xl border border-saffron-50 shadow-sm">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500" data-key="card2Desc">
